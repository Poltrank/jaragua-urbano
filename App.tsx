...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-emerald-100 selection:text-emerald-900 flex flex-col">
      ...
      {/* Footer */}
      <footer className="py-12 bg-slate-100 border-t border-slate-200 mb-20 lg:mb-0">
        <div className="container mx-auto px-6 max-w-6xl flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-0">
          <div className="flex flex-col gap-2 items-center lg:items-start text-center lg:text-left">
            ...
            <div className="flex flex-col gap-1 items-center lg:items-start">
              ...
              {/* CADEADO ADMINISTRATIVO - Posicionado discretamente */}
              <button 
          ...
          <div className="flex gap-8">
            <button className="text-[10px] font-black text-emerald-600 uppercase tracking-widest hover:underline">Seja um Parceiro</button>
          </div>
        </div>
      </footer>
